...
![Portfolio Browser — главное окно с загруженной страницей Google](docs/screenshot.png)

*Скриншот: панель навигации, адресная строка и отображение веб-страницы через WebView2.*
